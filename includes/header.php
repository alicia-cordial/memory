    ...
    <nav>
        <div class="nav-wrapper black">
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li><a href="walloffame.php" class="navlink">Wall of Fame</a></li>
                <!-- Utilisateur déconnecté -->
                <li class="navlink <?php if (!isset($_SESSION['user'])) { echo 'disabled'; } ?>"><a href="level.php">Commencer une partie</a></li>
